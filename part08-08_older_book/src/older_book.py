...
# def older_book(Book("Python","P. Python", "non-fiction", 2000), Book("Java", "J.Java", "non-fiction", 2001))
...
if __name__ == "__main__":
    python = Book("Python","P. Python", "non-fiction", 2000)
    everest = Book("Java", "J.Java", "non-fiction", 2001)
